...
public class QuoteServer {
    ...
    String[] getQuotes() {
        ...
        //first method to get whole array of quotes
    ...
    //second method to get single quote
    String getRandomQuote() {
        ...
        int randomQuote = ThreadLocalRandom.current().nextInt(quotesArrayLen);

        quote = getQuotes()[randomQuote];
